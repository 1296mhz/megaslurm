...
class LDAPAuthHandler(AuthHandler):
    ...
    def do_GET(self):
        ...
        try:
            ...
            ctx['action'] = 'running groups search query'
            results = ldap_obj.search_s(ctx['basedn'], ldap.SCOPE_SUBTREE,
                                        searchfilter,
                                        ['memberof'], 0)[0][1]['memberOf']
            ...
            for result in results:
                if result.split(',')[1] == 'OU=%s' % ctx['groupou']:
                    self.send_header('X-Remote-Group' + str(i),
...
if __name__ == '__main__':
    ...
    group.add_argument('--host',  metavar="hostname",
        default="", help="host to bind (Default: 0.0.0.0)")
    ...
    group.add_argument('-g', metavar="groupou", dest="groupou", default='',
        help="LDAP OU to search groups in (Default: unset)")
    ...
    auth_params = {
             ...
             'groupou': ('X-Ldap-GroupOU', args.groupou),
